...
function ingestBySheetName(stateName, sheetName){
  var data =  getDataByRegionCode(stateName,sheetName)
  postData(stateName,sheetName, data)
}

function getDataByRegionCode(stateName,sheetName) {
  Logger.log(sheetName)
  ...
  for (var i = 0; startRow + interval * i <= lastRow; i++) {
    ...
    var dataset_1 =  getRegionObject(stateName,sheet, row, 'C', 'B', 'G', 'G', 'G', 'G', 'G', 'G', 'G', 'B', 'H')
    var dataset_2 =  getRegionObject(stateName,sheet, row, 'K', 'J', 'O', 'O', 'O', 'O', 'O', 'O', 'O', 'J', 'P')
    var dataset_3 =  getRegionObject(stateName,sheet, row, 'S', 'R', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'R', 'X')
