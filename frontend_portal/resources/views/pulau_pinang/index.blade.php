...
<div class="container mt-5">
    <div class="row">
        <h2 class="text-center">PULAU PINANG</h2>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <div class="d-flex justify-content-between mt-3">
                <form action="{{ route('pulau_pinang.index') }}" method="GET" class="mb-3">
        ...
        <div class="col-md-6 mt-4">
            <div class="card" style="width: 30rem;">
                <img src="/img/pp-map.png" class="card-img-top" alt="Pulau Pinang">
            </div>
        </div>
    </div>
</div>
