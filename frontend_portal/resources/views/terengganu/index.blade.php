...
<div class="container mt-5">
    <div class="row">
        <h2 class="text-center">TERENGGANU</h2>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <div class="d-flex justify-content-between mt-3">
                <form action="{{ route('terengganu.index') }}" method="GET" class="mb-3">
        ...
        <div class="col-md-6 mt-4">
            <div class="card" style="width: 30rem;">
                <img src="/img/terengganu-map.png" class="card-img-top" alt="terengganu">
            </div>
        </div>
    </div>
</div>
