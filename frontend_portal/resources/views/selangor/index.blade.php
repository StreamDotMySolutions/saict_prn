...
<div class="container mt-5">
    <div class="row">
        <h2 class="text-center">SELANGOR</h2>
    </div>
    ...
    <div class="progress-stacked mt-3">
        <div class="progress progress-height" role="progressbar" aria-label="Segment one" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
            <div class="progress-bar overflow-visible text-light" style="background-color: rgb(216, 35, 43); height:30px;">PH</div>
        </div>
        <div class="progress progress-height" role="progressbar" aria-label="Segment two" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 30%">
            <div class="progress-bar overflow-visible text-light" style="background-color: rgb(0, 49, 82); height:30px;">PN</div>
        </div>
        <div class="progress progress-height" role="progressbar" aria-label="Segment three" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: 20%">
            <div class="progress-bar overflow-visible text-light" style=" background-color: rgb(0, 0, 128); height:30px;">BN</div>
        </div>
    </div>
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <div class="d-flex justify-content-between mt-3">
                <form action="{{ route('selangor.index') }}" method="GET" class="mb-3">
        ...
        <div class="col-md-6 mt-4">
            <div class="card" style="width: 30rem;">
                <img src="/img/Selangor-map.png" class="card-img-top" alt="Selangor">
            </div>
        </div>
    </div>
</div>
